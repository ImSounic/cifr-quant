...
#SBATCH --mem=64G
#SBATCH --output=slurm/logs/cqr_calibrate_%j.out
#SBATCH --error=slurm/logs/cqr_calibrate_%j.err
...
# Run CQR for all assets: 30 MC paths, 90% coverage
python scripts/calibrate_cqr_multi.py \
    --market all \
    --n-paths 30 \
    --coverage 0.90
