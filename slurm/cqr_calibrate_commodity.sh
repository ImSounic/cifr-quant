...
# Commodity CQR is cheap (pred_len=6, ~89 windows x 6 assets) — finishes well
# under the wall clock. Results are saved incrementally per asset.

mkdir -p /home/s3702111/cifr-quant/slurm/logs
LOGFILE="/home/s3702111/cifr-quant/slurm/logs/cqr_comm_${SLURM_JOB_ID}.log"
